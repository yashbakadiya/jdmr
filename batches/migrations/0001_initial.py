...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('students', '0002_addstudentinst_registration_date'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institute', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='BatchTiming', to='accounts.institute')),
            ],
        ),
        migrations.CreateModel(
            name='Notice',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('request', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='students.unconfirmedstudentinst')),
