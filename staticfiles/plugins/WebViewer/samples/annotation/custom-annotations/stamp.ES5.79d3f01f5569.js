!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      h(Ct, Bt),
        p(Ct, yt, Bt.values),
        h(Ct, { slice: Rt, set: kt, constructor: function() {}, toString: pt, toLocaleString: Dt }),
        Nt(Ct, 'buffer', 'b'),
        Nt(Ct, 'byteOffset', 'o'),
        Nt(Ct, 'byteLength', 'l'),
        Nt(Ct, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    function C(t, n, r, e, o, i) {
      ...
      for (var c = t[L]._b, f = u + t[z], a = e(+o), s = 0; s < n; s++) c[f + s] = a[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !a(function() {
    ...
    var o = r(1),
      ...
      Z =
        ...
        s(function() {
          ...
          : T,
      K = function(t) {
        var n = (H[t] = F(D.prototype));
        return (n._k = t), n;
      },
      U =
        G && 'symbol' == e(D.iterator)
          ? function(t) {
              return 'symbol' == e(t);
            }
          : function(t) {
      ...
      q = function(t, n, r) {
        return (
          ...
          (n = P(n, !0)),
          m(r),
          i(H, n) ? (r.enumerable ? (i(t, k) && t[k][n] && (t[k][n] = !1), (r = F(r, { enumerable: A(0, !1) }))) : (i(t, k) || T(t, k, A(1, {})), (t[k][n] = !0)), Z(t, n, r)) : T(t, n, r)
        );
      },
      Q = function(t, n) {
        m(t);
    ...
    (function(t) {
      ...
      var r = (function(t) {
        ...
        var y = Object.getPrototypeOf,
          g = y && y(y(A([])));
        g && g !== r && e.call(g, i) && (h = g);
        var d = (p.prototype = l.prototype = Object.create(h));
        function b(t) {
        ...
        return (
          (v.prototype = d.constructor = p),
          (p.constructor = v),
          (p[c] = v.displayName = 'GeneratorFunction'),
      ...
      return new ((function(t) {
        ...
        function g() {
          ...
          return (
            ...
            delete (t = y.call(this, n, a.StampAnnotation)).defaults.StrokeColor,
        ...
        return (
          ...
          (p = [
            ...
            },
            {
              ...
              value: function(t) {
                var n;
                if ((o(f(g.prototype), 'mouseLeftDown', this).call(this, t), this.annotation)) {
                  var e = 212,
                    i = 60,
                    u = 90 * this.docViewer.getCompleteRotation(this.annotation.PageNumber);
                  if (((this.annotation.Rotation = u), 270 === u || 90 === u)) {
                    var c = i;
                    (i = e), (e = c);
                  }
                  (this.annotation.ImageData =
                    ...
                    (this.annotation.Height = i),
                    (this.annotation.X -= e / 2),
                    (this.annotation.Y -= i / 2),
                    (this.annotation.MaintainAspectRatio = !0),
                    (n = this.annotation);
                }
                o(f(g.prototype), 'mouseLeftUp', this).call(this, t), n && r.redrawAnnotation(n);
              },
            },
          ]) && e(v.prototype, p),
          h && e(v, h),
