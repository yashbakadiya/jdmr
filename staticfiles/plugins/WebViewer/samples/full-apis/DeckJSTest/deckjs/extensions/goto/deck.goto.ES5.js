...
*/
    ...
    (r = jQuery),
      (e = 'deck'),
      (o = r(document)),
      r.extend(!0, r[e].defaults, {
        classes: { goto: 'deck-goto' },
        selectors: { gotoDatalist: '#goto-datalist', gotoForm: '.goto-form', gotoInput: '#goto-slide' },
        keys: { goto: 71 },
        countNested: !0,
      }),
      r[e]('extend', 'showGoTo', function() {
        r[e]('getContainer').addClass(r[e]('getOptions').classes.goto), r(r[e]('getOptions').selectors.gotoInput).focus();
      }),
      r[e]('extend', 'hideGoTo', function() {
        r(r[e]('getOptions').selectors.gotoInput).blur(), r[e]('getContainer').removeClass(r[e]('getOptions').classes.goto);
      }),
      r[e]('extend', 'toggleGoTo', function() {
        r[e](r[e]('getContainer').hasClass(r[e]('getOptions').classes.goto) ? 'hideGoTo' : 'showGoTo');
      }),
      o.bind('deck.init', function() {
        var t = r[e]('getOptions'),
          ...
          i = r
            ...
            .join(', '),
          u = 1;
        o.unbind('keydown.deckgoto').bind('keydown.deckgoto', function(t) {
          var n = r[e]('getOptions').keys.goto;
          (t.which === n || r.inArray(t.which, n) > -1) && (t.preventDefault(), r[e]('toggleGoTo'));
        }),
          r.each(r[e]('getSlides'), function(r, e) {
            var o = e.attr('id'),
              c = e.parentsUntil(t.selectors.container, i);
            o && n.append('<option value="' + o + '">'), c.length ? e.removeData('rootIndex') : t.countNested || (e.data('rootIndex', u), ++u);
          }),
          r(t.selectors.gotoForm)
            .unbind('submit.deckgoto')
            .bind('submit.deckgoto', function(t) {
              var n = r(r[e]('getOptions').selectors.gotoInput),
                o = parseInt(n.val(), 10);
              if (!r[e]('getOptions').countNested) {
                if (o >= u) return !1;
                r.each(r[e]('getSlides'), function(t, n) {
                  if (n.data('rootIndex') === o) return (o = t + 1), !1;
                });
              }
              r[e]('go', isNaN(o) ? n.val() : o - 1), r[e]('hideGoTo'), n.val(''), t.preventDefault();
            }),
