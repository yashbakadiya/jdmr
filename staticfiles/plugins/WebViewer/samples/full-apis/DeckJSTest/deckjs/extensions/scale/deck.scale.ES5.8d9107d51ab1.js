  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Gt = function(t, n, r) {
          return !(Dt(t, (n = m(n, !0))) && w(r) && S(r, 'value')) || S(r, 'get') || S(r, 'set') || r.configurable || (S(r, 'writable') && !r.writable) || (S(r, 'enumerable') && !r.enumerable)
            ? B(t, n, r)
            : ((t[n] = r.value), t);
        };
      mt || ((G.f = Ut), (U.f = Gt)),
      ...
      var o,
        ...
        a = function() {
          ...
          t.each(i, function(n, e) {
            f(e, r);
            var i = e.innerHeight(),
              c = e.find('.' + r.classes.scaleSlideWrapper),
              a = o.hasClass(r.classes.scale) ? u / i : 1;
            t.each('Webkit Moz O ms Khtml'.split(' '), function(t, n) {
              1 === a ? c.css(n + 'Transform', '') : c.css(n + 'Transform', 'scale(' + a + ')');
            });
          });
        };
      t.extend(!0, t[n].defaults, { classes: { scale: 'deck-scale', scaleSlideWrapper: 'deck-slide-scaler' }, keys: { scale: 83 }, baseHeight: null, scaleDebounce: 200 }),
        t[n]('extend', 'disableScale', function() {
          t[n]('getContainer').removeClass(t[n]('getOptions').classes.scale), a();
        }),
        t[n]('extend', 'enableScale', function() {
          t[n]('getContainer').addClass(t[n]('getOptions').classes.scale), a();
        }),
        t[n]('extend', 'toggleScale', function() {
          var r = t[n]('getContainer');
          t[n](r.hasClass(t[n]('getOptions').classes.scale) ? 'disableScale' : 'enableScale');
        }),
        u.bind('deck.init', function() {
          var e = t[n]('getOptions'),
            s = t
              .map([e.classes.before, e.classes.previous, e.classes.current, e.classes.next, e.classes.after], function(t, n) {
                return '.' + t;
              })
              .join(', ');
          (i = []),
            t.each(t[n]('getSlides'), function(t, n) {
              n.parentsUntil(e.selectors.container, s).length || i.push(n);
            }),
            ...
            c
              ...
              .bind('resize.deckscale', function() {
                r.clearTimeout(o), (o = r.setTimeout(a, e.scaleDebounce));
              })
              .unbind('load.deckscale')
              .bind('load.deckscale', a),
            u.unbind('keydown.deckscale').bind('keydown.deckscale', function(r) {
              (r.which === e.keys.scale || t.inArray(r.which, e.keys.scale) > -1) && (t[n]('toggleScale'), r.preventDefault());
            }),
            t[n]('enableScale');
        });
    })(jQuery, 'deck', this);
