...
*/
    !(function(t, n, r, e) {
      var o,
        ...
        u = t(r),
        c = function(r) {
          var e = r.substr(r.indexOf('#') + 1),
            o = t[n]('getSlides');
          t.each(o, function(r, o) {
            if (o.attr('id') === e) return t[n]('go', r), !1;
          }),
            t[n]('getContainer')
              .scrollLeft(0)
              .scrollTop(0);
        };
      t.extend(!0, t[n].defaults, { selectors: { hashLink: '.deck-permalink' }, hashPrefix: 'slide-', preventFragmentScroll: !0 }),
        i
          .bind('deck.init', function() {
            var e = t[n]('getOptions');
            (o = t()),
              (slides = t[n]('getSlides')),
              t.each(slides, function(i, u) {
                var c;
                (u.attr('id') && u.data('deckAssignedId') !== u.attr('id')) || (u.attr('id', e.hashPrefix + i), u.data('deckAssignedId', e.hashPrefix + i)),
                  (c = '#' + u.attr('id')) === r.location.hash && t[n]('go', i),
                  (o = o.add('a[href="' + c + '"]'));
              }),
              ...
              slides.length && t[n]('getContainer').addClass(e.classes.onPrefix + t[n]('getSlide').attr('id'));
          })
          .bind('deck.change', function(e, o, i) {
            var u = '#' + t[n]('getSlide', i).attr('id'),
              c = r.location.href.replace(/#.*/, '') + u,
              f = t[n]('getOptions'),
              a = f.classes.onPrefix,
              s = t[n]('getContainer');
            s.removeClass(a + t[n]('getSlide', o).attr('id')),
              s.addClass(a + t[n]('getSlide', i).attr('id')),
              t(f.selectors.hashLink).attr('href', c),
              Modernizr.history && r.history.replaceState({}, '', c);
          }),
        u
          ...
          .bind('load', function() {
            t[n]('getOptions').preventFragmentScroll &&
              t[n]('getContainer')
                .scrollLeft(0)
                .scrollTop(0);
          });
