!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Bt, Dt),
        p(Bt, yt, Dt.values),
        v(Bt, { slice: Rt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: kt }),
        jt(Bt, 'buffer', 'b'),
        jt(Bt, 'byteOffset', 'o'),
        jt(Bt, 'byteLength', 'l'),
        jt(Bt, 'length', 'e'),
...
*/
    ...
    (r = jQuery),
      (e = 'deck'),
      (i = r(document)),
      r.extend(!0, r[e].defaults, { classes: { menu: 'deck-menu' }, keys: { menu: 77 }, touch: { doubletapWindow: 400 } }),
      r[e]('extend', 'showMenu', function() {
        var t = r[e]('getContainer'),
          n = r[e]('getOptions');
        t.hasClass(n.classes.menu) ||
          ...
          window.setTimeout(function() {
            t.removeClass(n.classes.loading).scrollTop(r[e]('getSlide').offset().top);
          }, 0));
      }),
      r[e]('extend', 'hideMenu', function() {
        var t = r[e]('getContainer'),
          n = r[e]('getOptions');
        t.hasClass(n.classes.menu) &&
      ...
      r[e]('extend', 'toggleMenu', function() {
        r[e]('getContainer').hasClass(r[e]('getOptions').classes.menu) ? r[e]('hideMenu') : r[e]('showMenu');
      }),
      i
        .bind('deck.init', function() {
          var t,
            ...
            c = r
              ...
              .join(', ');
          (o = []),
            r.each(r[e]('getSlides'), function(t, r) {
              r.parentsUntil(n.selectors.container, c).length || o.push(r);
            }),
            i.unbind('keydown.deckmenu').bind('keydown.deckmenu', function(t) {
              (t.which === n.keys.menu || r.inArray(t.which, n.keys.menu) > -1) && (r[e]('toggleMenu'), t.preventDefault());
            }),
            r[e]('getContainer')
              ...
              .bind('touchend.deckmenu', function(o) {
                var i = Date.now();
                t === r[e]('getSlide') && (i - u < n.touch.doubletapWindow && (r[e]('toggleMenu'), o.preventDefault()), (u = i));
              }),
            r.each(r[e]('getSlides'), function(t, o) {
              o.unbind('click.deckmenu').bind('click.deckmenu', function(o) {
                r[e]('getContainer').hasClass(n.classes.menu) && (r[e]('go', t), r[e]('hideMenu'), o.stopPropagation(), o.preventDefault());
              });
            });
        })
        .bind('deck.change', function(t, n, o) {
          var i = r[e]('getContainer');
          i.hasClass(r[e]('getOptions').classes.menu) && i.scrollTop(r[e]('getSlide', o).offset().top);
        });
  },
]);
