                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 72:
                            return (d = t.sent).initSecurityHandler(), d.lock(), (t.next = 77), d.getPageCount();
                          case 77:
                            g = t.sent;
                          case 78:
                            if (!(g >= 1)) {
                            ...
                            return (t.next = 81), d.getPageIterator(g);
                          case 81:
                            (m = t.sent), d.pageRemove(m), (g -= 2), (t.next = 78);
                            break;
                          case 86:
                            return (t.next = 88), d.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 88:
