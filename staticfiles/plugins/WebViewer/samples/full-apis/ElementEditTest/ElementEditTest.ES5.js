!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        (j && (x = s(j.call(new t()))) !== Object.prototype && x.next && (a(x, w, !0), e || 'function' == typeof x[l] || u(x, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
                  ...
                  switch ((t.prev = t.next)) {
                    ...
                    case 17:
                      (s = t.sent),
                        ...
                        (t.t0 = s),
                        (t.next =
                          t.t0 === n.Element.Type.e_image || t.t0 === n.Element.Type.e_inline_image
                            ? 24
                    ...
                    case 42:
                      if (((p = t.sent), (h = p.getObjNum()), -1 !== i.indexOf(h))) {
                        t.next = 58;
                        break;
                      }
                      return (t.next = 47), p.getObjNum();
                    case 47:
                      return (v = t.sent), i.includes(v) || i.push(v), (t.next = 51), n.ElementWriter.create();
                    case 51:
                      return (y = t.sent), e.formBegin(), y.beginOnObj(p, !0), (t.next = 56), r(e, y, i);
                    case 56:
                      y.end(), e.end();
                    case 58:
                      return t.abrupt('break', 60);
              ...
              return regeneratorRuntime.wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    ...
                    case 35:
                      return (p = t.sent), (t.next = 38), p.getObjNum();
                    case 38:
                      return (h = t.sent), c.includes(h) || c.push(h), u.beginOnPage(s), i.beginOnPage(s, n.ElementWriter.WriteMode.e_replacement, !1), (t.next = 44), r(u, i, c);
                    case 44:
                      i.end(), u.end();
                    case 46:
                      a.next(), (t.next = 23);
