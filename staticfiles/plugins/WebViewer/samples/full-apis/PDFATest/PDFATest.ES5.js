  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        kt = function(t, n) {
          return At(this, ht.call(Ot(this), t, n));
        },
        Dt = function(t) {
          Ot(this);
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? P : S('values'), keys: d ? P : S('keys'), entries: A }), g)) for (b in m) b in F || i(F, b, m[b]);
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            ...
            var A = b.groups;
            if (p) {
              var M = [E].concat(O, F, h);
              void 0 !== A && M.push(A);
              var j = String(n.apply(void 0, M));
            } else j = y(E, h, F, O, A, n);
            ...
            var t,
              e =
                ((t = regeneratorRuntime.mark(function t() {
                  var r, e, o, i, u, c, f, a, s, l, h, p, v, y, d, g, m, b, x;
                        ...
                        switch ((t.prev = t.next)) {
                          ...
                          case 51:
                            return (
                              ...
                              (y = ''),
                              (d = 10),
                              (g = '../TestFiles/' + (p = 'fish.pdf')),
                              console.log('Converting input document: ' + p),
                              (t.next = 63),
                              n.PDFACompliance.createFromUrl(!0, g, y, n.PDFACompliance.Conformance.e_Level1B, void 0, d)
                            );
                          case 63:
                          ...
                          case 72:
                            return (b = t.sent), saveBufferAsPDFDoc(b, v), (t.next = 77), n.PDFACompliance.createFromBuffer(!1, b, y, n.PDFACompliance.Conformance.e_Level1B, void 0, d);
                          case 77:
