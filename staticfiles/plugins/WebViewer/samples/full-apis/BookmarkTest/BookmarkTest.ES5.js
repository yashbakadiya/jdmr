!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), x = o(g), m = e(c, v, 3), b = u(x.length), S = 0, w = r ? h(n, b) : a ? h(n, 0) : void 0; b > S; S++)
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Vt, Ct),
        h(Vt, yt, Ct.values),
        v(Vt, { slice: Lt, set: Dt, constructor: function() {}, toString: ht, toLocaleString: Rt }),
        kt(Vt, 'buffer', 'b'),
        kt(Vt, 'byteOffset', 'o'),
        kt(Vt, 'byteLength', 'l'),
        kt(Vt, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var x,
        ...
        P = O || S(y),
        A = y ? (_ ? S('entries') : P) : void 0,
        M = ('Array' == n && F.entries) || O;
      if (
        (M && (b = s(M.call(new t()))) !== Object.prototype && b.next && (f(b, w, !0), e || 'function' == typeof b[l] || u(b, l, h)),
        _ &&
          O &&
          'values' !== O.name &&
          ((E = !0),
        ...
        if (((x = { values: _ ? P : S('values'), keys: d ? P : S('keys'), entries: A }), g)) for (m in x) m in F || i(F, m, x[m]);
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            g = 0,
            x = s(p);
          if ((d && (y = e(y, v > 2 ? arguments[2] : void 0, 2)), null == x || (h == Array && c(x)))) for (r = new h((n = a(p.length))); n > g; g++) f(r, g, d ? y(p[g], g) : p[g]);
          else for (l = x.call(p), r = new h(); !(o = l.next()).done; g++) f(r, g, d ? u(l, y, [o.value, g], !0) : o.value);
          return (r.length = g), r;
        },
      }
    );
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var b, S = '', w = 0, _ = 0; _ < x.length; _++) {
            m = x[_];
            for (var E = String(m[0]), F = f(s(u(m.index), p.length), 0), O = [], P = 1; P < m.length; P++) O.push(void 0 === (b = m[P]) ? b : String(b));
            var A = m.groups;
            if (h) {
              var M = [E].concat(O, F, p);
              void 0 !== A && M.push(A);
              var k = String(n.apply(void 0, M));
            } else k = y(E, p, F, O, A, n);
            F >= w && ((S += p.slice(w, F) + k), (w = F + E.length));
          }
          return S + p.slice(w);
        },
      ];
  ...
  function(t, n, r) {
    for (
      ...
      var d,
        ...
        m = u[g],
        b = m && m.prototype;
      if (b && (b[s] || c(b, s, p), b[l] || c(b, l, g), (a[g] = p), x)) for (d in e) b[d] || i(b, d, e[d], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
          ...
          i = (function() {
            var t = e(
              regeneratorRuntime.mark(function t() {
                var r, e, i, u, c, a, f, s, l, p, h, v, y, d, g, x, m, b, S, w, _, E, F, O, P, A, M, k, j, I, N, R, T, L;
                return regeneratorRuntime.wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                      ...
                      case 43:
                        return (p = t.sent), (t.t2 = u), (t.next = 47), n.Action.createGoto(p);
                      case 47:
                        return (t.t3 = t.sent), t.t2.setAction.call(t.t2, t.t3), (h = 'blue1'), (t.next = 52), e.getPage(19);
                      case 52:
                        return (v = t.sent), (t.next = 55), n.Destination.createFit(v);
                      case 55:
                        return (y = t.sent), (t.next = 58), n.Action.createGotoWithKey(h, y);
                      case 58:
                      ...
                      case 186:
                        return (O = t.sent), saveBufferAsPDFDoc(O, 'bookmark.pdf'), console.log('Done. Result saved in bookmark.pdf'), (t.next = 191), n.PDFDoc.createFromBuffer(O);
                      case 191:
                        return (P = t.sent).initSecurityHandler(), P.lock(), (t.next = 196), P.getFirstBookmark();
                      case 196:
                        return (A = t.sent), (t.next = 199), o(A);
                      case 199:
                        return console.log('Done.'), (e = P).initSecurityHandler(), (t.next = 204), e.createIndirectDict();
                      case 204:
