!(function(t) {
  ...
  function(t, n, r) {
    ...
    function B(t, n, r, e) {
      var o = h(+r);
      if (o + n > t[T]) throw m('Wrong index!');
      var i = t[I]._b,
        u = o + t[A],
        c = i.slice(u, u + n);
    ...
    function G(t, n, r, e, o, i) {
      var u = h(+r);
      if (u + n > t[T]) throw m('Wrong index!');
      for (var c = t[I]._b, a = u + t[A], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      (x = function(t) {
        ...
        (b = function(t, n, r) {
          ...
          var e = t[T],
            o = l(n);
          if (o < 0 || o > e) throw m('Wrong offset!');
          if (o + (r = void 0 === r ? e - o : p(r)) > e) throw m('Wrong length!');
          (this[I] = t), (this[A] = o), (this[T] = r);
        }),
        o && (V(x, 'byteLength', '_l'), V(b, 'buffer', '_b'), V(b, 'byteLength', '_l'), V(b, 'byteOffset', '_o')),
        a(b.prototype, {
          getInt8: function(t) {
        ...
        [
          ...
          function(t, n) {
            ...
            for (var _ = 0, m = 0, S = []; m < p.length; ) {
              ...
              var w,
                E = a(x, v ? p : p.slice(m));
              if (null === E || (w = l(c(x.lastIndex + (v ? 0 : m)), p.length)) === _) m = u(p, m, g);
              else {
        ...
        function _(t, n) {
          ...
          if (void 0 === r) {
            if (((n.delegate = null), 'throw' === n.method)) {
              if (t.iterator.return && ((n.method = 'return'), (n.arg = void 0), _(t, n), 'throw' === n.method)) return s;
                    ...
                    switch ((t.prev = t.next)) {
                      ...
                      case 39:
                        (t.t5 = t.sent),
                          ...
                          r(u, i),
                          (t.t6 = s),
                          (t.next = t.t6 === n.ContentItem.Type.e_MCID || t.t6 === n.ContentItem.Type.e_MCR ? 45 : t.t6 === n.ContentItem.Type.e_OBJR ? 51 : 57);
                        break;
                      case 45:
