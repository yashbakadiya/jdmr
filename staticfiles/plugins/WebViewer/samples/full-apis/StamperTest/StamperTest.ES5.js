!(function(t) {
  ...
  function(t, n, e) {
    ...
    function U(t, n, e, r) {
      var o = h(+e);
      if (o + n > t[I]) throw b('Wrong index!');
      var i = t[M]._b,
        u = o + t[j],
        c = i.slice(u, u + n);
    ...
    function W(t, n, e, r, o, i) {
      var u = h(+e);
      if (u + n > t[I]) throw b('Wrong index!');
      for (var c = t[M]._b, a = u + t[j], f = r(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      (m = function(t) {
        ...
        (S = function(t, n, e) {
          ...
          (this[M] = t), (this[j] = o), (this[I] = e);
        }),
        o && (z(m, 'byteLength', '_l'), z(S, 'buffer', '_b'), z(S, 'byteLength', '_l'), z(S, 'byteOffset', '_o')),
        a(S.prototype, {
          getInt8: function(t) {
    ...
    d(m, 'ArrayBuffer'), d(S, 'DataView'), c(S.prototype, u.VIEW, !0), (n.ArrayBuffer = m), (n.DataView = S);
  },
  function(t, n) {
    var e = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = e);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, b = 0, w = []; b < p.length; ) {
              ...
              var _,
                F = a(m, v ? p : p.slice(b));
              if (null === F || (_ = l(c(m.lastIndex + (v ? 0 : b)), p.length)) === x) b = u(p, b, g);
              else {
        ...
        return (
          ...
          (_.prototype = {
            ...
            delegateYield: function(t, n, e) {
              return (this.delegate = { iterator: F(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = void 0), s;
            },
          }),
          t
        );
