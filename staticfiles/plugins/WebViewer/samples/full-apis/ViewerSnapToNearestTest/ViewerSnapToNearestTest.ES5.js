!(function(t) {
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), P = a(s(u(b.index), p.length), 0), O = [], M = 1; M < b.length; M++) O.push(void 0 === (x = b[M]) ? x : String(x));
            var F = b.groups;
            if (h) {
              var A = [E].concat(O, P, p);
              void 0 !== F && A.push(F);
              var I = String(n.apply(void 0, A));
            } else I = y(E, p, P, O, F, n);
            P >= w && ((S += p.slice(w, P) + I), (w = P + E.length));
          }
          return S + p.slice(w);
        },
      ];
  ...
  function(t, n) {
    ...
    window,
      (e = function(t) {
        var n = readerControl.docViewer.getDisplayModeManager().getDisplayMode(),
          r = (function(t) {
            var n = readerControl.docViewer.getScrollViewElement(),
              r = n.scrollLeft || 0,
              e = n.scrollTop || 0;
            return { x: t.pageX + r, y: t.pageY + e };
          })(t),
          e = n.getSelectedPages(r, r),
          o = null !== e.first ? e.first : readerControl.docViewer.getCurrentPage();
      ...
      window.addEventListener('documentLoaded', function() {
        ...
        (t = {
          ...
          panel: {
            ...
            render: function() {
              var t = readerControl.docViewer.SnapMode,
                n = t.DEFAULT,
                e = t.POINT_ON_LINE,
                o = t.LINE_MID_POINT,
          ...
          readerControl.setCustomPanel(t),
        ...
        var o = readerControl.docViewer.getAnnotationManager();
        o.addAnnotation(n),
          readerControl.docViewer.on('mouseMove', function(t) {
            var i = e(t),
              u = i.point,
              c = i.pageNumber,
              f = n.PageNumber;
            (n.PageNumber = c),
              ...
              readerControl.docViewer.snapToNearest(c, u.x, u.y, r).then(function(t) {
