              ...
              (t = (function() {
                var t = e(
                  regeneratorRuntime.mark(function t(n) {
                    var r, e, i, u, c, f, a, s, l, p, h, v, y, d, g;
                    return regeneratorRuntime.wrap(function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 31:
                            return (p = t.sent), (t.next = 34), p.isValid();
                          case 34:
                            if (t.sent) {
                              t.next = 36;
                              break;
                          ...
                          case 36:
                            return (t.next = 38), p.getType();
                          case 38:
                            (h = t.sent), (t.t0 = h), (t.next = t.t0 === o.Annot.Type.e_Stamp ? 42 : 73);
                            break;
                          case 42:
                          ...
                          case 51:
                            return (d = t.sent), e.writePlacedElement(d), (t.next = 55), e.end();
                          case 55:
                            return (g = t.sent).putRect('BBox', 0, 0, v, y), g.putName('Subtype', 'Form'), g.putName('Type', 'XObject'), (t.next = 61), i.createFormFromStream(g);
                          case 61:
                            return (d = t.sent), e.writePlacedElement(d), (t.next = 65), e.end();
                          case 65:
                            return (g = t.sent).putRect('BBox', 0, 0, v, y), g.putName('Subtype', 'Form'), g.putName('Type', 'XObject'), (t.next = 71), p.setAppearance(g);
                          case 71:
                ...
                regeneratorRuntime.mark(function t(n) {
                  return regeneratorRuntime.wrap(function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          readerControl.loadDocument(n), console.log('finished script');
                        case 2:
                        case 'end':
                          return t.stop();
                      }
