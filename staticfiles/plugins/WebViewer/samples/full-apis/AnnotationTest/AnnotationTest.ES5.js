!(function(t) {
  ...
  function(t, n, e) {
    ...
    function U(t, n, e, r, o, i) {
      ...
      for (var u = t[F]._b, a = c + t[R], s = r(+o), f = 0; f < n; f++) u[a + f] = s[i ? f : n - f - 1];
    }
    if (c.ABV) {
      if (
        !s(function() {
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, m = 0, w = []; m < p.length; ) {
              ...
              var P,
                A = a(x, v ? p : p.slice(m));
              if (null === A || (P = l(u(x.lastIndex + (v ? 0 : m)), p.length)) === b) m = c(p, m, d);
              else {
    ...
    (function(t) {
      ...
      var e = (function(t) {
        ...
        return (
          ...
          (h.constructor = p),
          (h[u] = p.displayName = 'GeneratorFunction'),
          ...
          (P.prototype = {
            ...
            delegateYield: function(t, n, e) {
              return (this.delegate = { iterator: A(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = void 0), f;
            },
          }),
          t
        );
