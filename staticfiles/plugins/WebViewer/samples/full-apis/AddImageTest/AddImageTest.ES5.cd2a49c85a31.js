  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Bt = function(t, n) {
          return Ct(t, (n = x(n, !0))) ? h(2, t[n]) : V(t, n);
        },
        Ut = function(t, n, r) {
          return !(Ct(t, (n = x(n, !0))) && w(r) && b(r, 'value')) || b(r, 'get') || b(r, 'set') || r.configurable || (b(r, 'writable') && !r.writable) || (b(r, 'enumerable') && !r.enumerable)
            ? G(t, n, r)
            : ((t[n] = r.value), t);
        };
      xt || ((U.f = Bt), (B.f = Ut)),
  ...
  function(t, n, r) {
    ...
    if (u.ABV) {
      ...
      (m = function(t) {
        ...
        o && (B(m, 'byteLength', '_l'), B(x, 'buffer', '_b'), B(x, 'byteLength', '_l'), B(x, 'byteOffset', '_o')),
        a(x.prototype, {
          getInt8: function(t) {
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                E = a(m, v ? h : h.slice(S));
              if (null === E || (_ = l(c(m.lastIndex + (v ? 0 : S)), h.length)) === b) S = u(h, S, g);
              else {
