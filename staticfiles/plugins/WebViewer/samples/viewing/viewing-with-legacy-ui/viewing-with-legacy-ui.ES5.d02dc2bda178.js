!(function(t) {
  ...
  function(t, n) {
    WebViewer({ path: '../../../lib', initialDoc: 'https://pdftron.s3.amazonaws.com/downloads/pl/demo-annotated.pdf', ui: 'legacy', enableRedaction: !0 }, document.getElementById('viewer')).then(
      function(t) {
        samplesSetup(t),
