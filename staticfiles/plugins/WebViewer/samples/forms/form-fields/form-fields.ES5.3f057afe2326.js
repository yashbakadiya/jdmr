!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Bt = function(t, n) {
          return Dt(t, (n = b(n, !0))) ? h(2, t[n]) : U(t, n);
        },
        Vt = function(t, n, r) {
  ...
  function(t, n) {
    WebViewer({ path: '../../../lib', pdftronServer: 'https://demo.pdftron.com/', initialDoc: 'https://pdftron.s3.amazonaws.com/downloads/pl/form1.pdf' }, document.getElementById('viewer')).then(
      function(t) {
        samplesSetup(t);
        var n = t.docViewer,
          r = t.annotManager,
        ...
        n.on('documentLoaded', function() {
          var t = n.getPageCount(),
            o = e.WidgetAnnotation.getCustomStyles,
            i = e.WidgetAnnotation.getContainerCustomStyles,
            u = function(t) {
              return t instanceof e.TextWidgetAnnotation
                ? 'f1-1' === t.fieldName
                  ? { 'background-color': 'lightgreen' }
                  : { 'background-color': 'lightblue', color: 'brown' }
                : t instanceof e.PushButtonWidgetAnnotation
                ? { 'background-color': 'red', color: 'white' }
                : void 0;
            },
            c = function(t) {
              if (t instanceof e.WidgetAnnotation) return { border: '2px solid green' };
            };
          document.getElementById('form').onchange = function(n) {
            'custom' === n.target.id
              ? ((e.WidgetAnnotation.getCustomStyles = u), (e.WidgetAnnotation.getContainerCustomStyles = c))
              : ((e.WidgetAnnotation.getCustomStyles = o), (e.WidgetAnnotation.getContainerCustomStyles = i));
            for (var f = 0; f < t; f++) r.drawAnnotations(f + 1, null, !0);
          };
        });
      }
    );
