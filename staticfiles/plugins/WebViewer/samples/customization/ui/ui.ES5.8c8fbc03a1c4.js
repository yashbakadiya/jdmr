!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Ut, Ct),
        p(Ut, yt, Ct.values),
        v(Ut, { slice: Rt, set: Bt, constructor: function() {}, toString: pt, toLocaleString: Lt }),
        At(Ut, 'buffer', 'b'),
        At(Ut, 'byteOffset', 'o'),
        At(Ut, 'byteLength', 'l'),
        At(Ut, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var m,
        ...
        P = O || x(y),
        M = y ? (_ ? x('entries') : P) : void 0,
        I = ('Array' == n && F.entries) || O;
      if (
        ...
        if (((m = { values: _ ? P : x('values'), keys: d ? P : x('keys'), entries: M }), g)) for (b in m) b in F || i(F, b, m[b]);
    ...
    var e,
      ...
      j = !!(function() {
        try {
          ...
          return (M || 'function' == typeof PromiseRejectionEvent) && t.then(I) instanceof n && 0 !== O.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(G, n) ? (r.enumerable ? (i(t, B) && t[B][n] && (t[B][n] = !1), (r = F(r, { enumerable: E(0, !1) }))) : (i(t, B) || N(t, B, E(1, {})), (t[B][n] = !0)), q(t, n, r)) : N(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === V && i(G, t) && !i(U, t)) && (!(n || !i(this, t) || !i(G, t) || (i(this, B) && this[B][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== V || !i(G, n) || i(U, n))) {
          var r = j(t, n);
          return !r || !i(G, n) || (i(t, B) && t[B][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = T(w(t)), e = [], o = 0; r.length > o; ) i(G, (n = r[o++])) || n == B || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
      ...
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(U, r), i(this, B) && i(this[B], t) && (this[B][t] = !1), q(this, t, E(1, r));
            };
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < m.length; _++) {
            ...
            var M = b.groups;
            if (p) {
              var I = [E].concat(O, F, h);
              void 0 !== M && I.push(M);
              var A = String(n.apply(void 0, I));
            } else A = y(E, h, F, O, M, n);
            F >= w && ((x += h.slice(w, F) + A), (w = F + E.length));
          }
          return x + h.slice(w);
        },
      ];
  ...
  function(t, n) {
    WebViewer(
      ...
      var n = function() {
        ...
        r = function(n, r) {
          n.target.checked ? t.enableElements([r]) : t.disableElements([r]);
        };
      NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = Array.prototype.forEach),
        ...
        (document.getElementById('ribbons').onchange = function(n) {
          n.target.checked ? t.enableFeatures([t.Feature.Ribbons]) : t.disableFeatures([t.Feature.Ribbons]);
        }),
        (document.getElementById('text-selection').onchange = function(n) {
          n.target.checked ? t.enableFeatures([t.Feature.TextSelection]) : t.disableFeatures([t.Feature.TextSelection]);
        }),
        (document.getElementById('annotations').onchange = function(n) {
          n.target.checked ? t.enableFeatures([t.Feature.Annotations]) : t.disableFeatures([t.Feature.Annotations]);
        }),
        (document.getElementById('notes-panel').onchange = function(n) {
          n.target.checked ? t.enableFeatures([t.Feature.NotesPanel]) : t.disableFeatures([t.Feature.NotesPanel]);
        }),
        (document.getElementById('file-picker').onchange = function(n) {
          n.target.checked ? t.enableFeatures([t.Feature.FilePicker]) : t.disableFeatures([t.Feature.FilePicker]);
        }),
        (document.getElementById('print').onchange = function(n) {
          n.target.checked ? t.enableFeatures([t.Feature.Print]) : t.disableFeatures([t.Feature.Print]);
        }),
        (document.getElementById('download').onchange = function(n) {
          n.target.checked ? t.enableFeatures([t.Feature.Download]) : t.disableFeatures([t.Feature.Download]);
        }),
        (document.getElementById('view-controls').onchange = function(t) {
          r(t, 'viewControlsButton');
        }),
        ...
        document.getElementsByName('theme').forEach(function(n) {
          n.onchange = function(n) {
            'light' === n.target.id && n.target.checked ? t.setTheme('light') : t.setTheme('dark');
          };
        });
    });
  },
