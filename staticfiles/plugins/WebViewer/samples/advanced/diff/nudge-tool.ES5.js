  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), m = o(g), b = e(c, v, 3), S = u(m.length), x = 0, w = r ? p(n, S) : a ? p(n, 0) : void 0; S > x; x++)
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (a = x(r)) || 'SharedArrayBuffer' == a)) return St in r ? Mt(v, r) : Tt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? F : x('values'), keys: d ? F : x('keys'), entries: A }), g)) for (b in m) b in O || i(O, b, m[b]);
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || j(t, C, E(1, {})), (t[C][n] = !0)), H(t, n, r)) : j(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === G && i(B, t) && !i(V, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
      ...
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === G, e = N(r ? V : w(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(G, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (a(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(V, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), H(this, t, E(1, r));
            };
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = f(s(u(b.index), h.length), 0), P = [], F = 1; F < b.length; F++) P.push(void 0 === (S = b[F]) ? S : String(S));
            var A = b.groups;
            if (p) {
  ...
  function(t, n, r) {
    for (
      ...
      var d,
        ...
        b = u[g],
        S = b && b.prototype;
      if (S && (S[s] || c(S, s, h), S[l] || c(S, l, g), (a[g] = h), m)) for (d in e) S[d] || i(S, d, e[d], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
  ...
  function(t, n) {
    !(function(t) {
      var n,
        ...
        e,
        o = this,
        i = 'HORIZONTAL_TRANSLATION_INC',
        u = 'HORIZONTAL_TRANSLATION_DEC',
        c = 'VERTICAL_TRANSLATION_INC',
        a = 'VERTICAL_TRANSLATION_DEC',
        f = 'ROTATION_INC',
        s = 'ROTATION_DEC',
        l = 'SCALE_IN',
        h = 'SCALE_OUT',
        p = { verticalTranslation: 0, horizontalTranslation: 0, rotation: 0, scaling: 0 },
        v = {},
        y = 1,
        d = function(t) {
        ...
        g = function(t) {
          var n = e.docViewer.getCurrentPage() - 1;
          v[n] = v[n] || Object.assign({}, p);
          var r = v[n];
          switch (t) {
            case i:
              r.horizontalTranslation += y;
              break;
            case u:
              r.horizontalTranslation -= y;
              break;
            case c:
              r.verticalTranslation += y;
              break;
            case a:
              r.verticalTranslation -= y;
              break;
      ...
      t.NudgeTool = {
        initNudgeTool: function(t, p, m) {
          (e = t), (y = p), (n = m);
          var b = document.createElement('div');
          b.setAttribute('id', 'nudge-diff-tool'),
            (b.innerHTML =
            ...
            (function(t) {
              var e = { rotateCounterClockwise: s, rotateClockwise: f, translateUp: a, translateLeft: u, translateRight: i, translateDown: c, scaleOut: h, scaleIn: l },
                p = function(t) {
                  var o = e[t];
                  g(o),
                    n && n(v),
            ...
            (v = {});
          var S = document
            .getElementById('middlePanel')
            .querySelector('iframe')
            .contentDocument.querySelector('body');
          S.insertBefore(b, S.firstChild);
        },
        resetPageTransformationStates: function() {
          v = {};
        },
        setPageTransformationState: function(t, r, e, o, i) {
          var u = { verticalTranslation: e, horizontalTranslation: r, rotation: i, scaling: o };
          (v[t] = u), n(v);
        },
        getPageTransformationState: function(t) {
          return v[t];
        },
      };
    })(window);
