!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Bt, Dt),
        h(Bt, yt, Dt.values),
        v(Bt, { slice: kt, set: Ct, constructor: function() {}, toString: ht, toLocaleString: Tt }),
        jt(Bt, 'buffer', 'b'),
        jt(Bt, 'byteOffset', 'o'),
        jt(Bt, 'byteLength', 'l'),
        jt(Bt, 'length', 'e'),
        ...
        var e = t.Annotations,
          ...
          u = r.map(function(n) {
            var r = n.box.x,
              ...
              a = [r, e + u],
              s = [r + i, e + u];
            return o(t.CoreControls.Math.Quad, a.concat(s, f, c));
          }),
          c = new e.RedactionAnnotation({ Quads: u });
        (c.Author = i.getCurrentUser()), (c.PageNumber = n), (c.StrokeColor = new e.Color(255, 0, 0, 1)), i.addAnnotation(c, !1), i.redrawAnnotation(c);
      }
    }
    function f(t, n) {
