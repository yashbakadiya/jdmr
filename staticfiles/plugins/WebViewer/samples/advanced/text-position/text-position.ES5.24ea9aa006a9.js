!(function(t) {
  ...
  function(t, n) {
    ...
    WebViewer({ path: '../../../lib', pdftronServer: 'https://demo.pdftron.com/', initialDoc: 'https://pdftron.s3.amazonaws.com/downloads/pl/legal-contract.pdf' }, r).then(function(t) {
      samplesSetup(t);
      var n = t.docViewer,
        r = t.annotManager,
        e = t.Annotations,
        o = function(t, o) {
          var i = n.getDocument();
          i.loadPageText(o).then(function(n) {
            for (var u, c = 0, f = []; (u = n.indexOf(t, c)) > -1; ) {
              c = u + t.length;
              var a = i.getTextPosition(o, u, u + t.length).then(function(t) {
                var n = new e.TextHighlightAnnotation();
                return (n.Author = r.getCurrentUser()), (n.PageNumber = o), (n.Quads = t), (n.StrokeColor = new e.Color(0, 255, 255)), n;
              });
              f.push(a);
            }
            Promise.all(f).then(function(t) {
              r.addAnnotations(t), r.selectAnnotations(t);
            });
          });
        },
        i = function(t) {
          var n = r.getAnnotationsList().filter(function(n) {
            return n.PageNumber === t;
          });
          r.deleteAnnotations(n);
        };
      n.on('documentLoaded', function() {
        ...
        r.forEach(function(n) {
          n.addEventListener('change', function() {
            ...
            n.checked && t.value ? o(t.value, r) : i(r);
          });
        }),
          t.addEventListener(
            'input',
            debounce(function() {
              r.forEach(function(n) {
                var r = Number(n.value);
                n.checked && (i(r), t.value && o(t.value, r));
              });
            }, 200)
          ),
          (r[0].checked = !0),
