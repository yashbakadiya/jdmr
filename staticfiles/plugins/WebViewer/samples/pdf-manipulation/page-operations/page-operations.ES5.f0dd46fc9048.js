    ...
    z ||
      (f(
        (L = function() {
          ...
          return u && H && q(U, t, { configurable: !0, set: n }), $(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
    ...
    WebViewer({ path: '../../../lib', useDownloader: !1, initialDoc: '../../../samples/files/demo.pdf' }, document.getElementById('viewer')).then(function(t) {
      ...
      n.on('documentLoaded', function() {
        var t = n.getDocument(),
          ...
          o = document.getElementById('move-from'),
          i = document.getElementById('move-to'),
          u = document.getElementById('insert-at'),
          c = document.getElementById('rotate'),
          f = document.getElementById('crop'),
          a = document.getElementById('delete'),
          s = document.getElementById('move'),
          l = document.getElementById('insert'),
          h = document.getElementById('file-picker'),
          p = function(t) {
            var n, r;
            for (e.innerHTML = '', o.innerHTML = '', i.innerHTML = '', u.innerHTML = '', n = 0; n < t; n++)
              ((r = document.createElement('option')).innerHTML = n + 1), e.appendChild(r), o.appendChild(r.cloneNode(!0)), i.appendChild(r.cloneNode(!0)), u.appendChild(r.cloneNode(!0));
            var c = r.cloneNode(!0);
            (c.innerHTML = n + 1), u.appendChild(c);
          };
        (c.onclick = function() {
          t.rotatePages([Number(e.value)], r.PageRotation.E_90);
        }),
          (f.onclick = function() {
            t.cropPages([Number(e.value)], 40, 40, 40, 40);
          }),
          (a.onclick = function() {
            var n = t.getPageCount() - 1;
            t.removePages([Number(e.value)]), p(n);
          }),
          (s.onclick = function() {
