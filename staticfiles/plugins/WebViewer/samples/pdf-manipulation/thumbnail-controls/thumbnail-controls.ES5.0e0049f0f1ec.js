!(function(t) {
  ...
  function(t, n) {
    ...
    CoreControls.setWorkerPath('../../../lib/core'),
      CoreControls.getDefaultBackendType().then(function(t) {
        (r = CoreControls.initPDFWorkerTransports(t, {})), o(e[0]), o(e[1]);
      });
    var o = function(t) {
      WebViewer({ path: '../../../lib', workerTransportPromise: { pdf: r }, useDownloader: !1, loadAsPDF: !0, initialDoc: t.initialDoc }, document.getElementById(''.concat(t.domElement))).then(
        function(n) {
          var r = n.docViewer;
          n.enableFeatures(['ThumbnailMultiselect', 'MultipleViewerMerging']),
            n.enableElements(['documentControl']),
            r.on('documentLoaded', function() {
              n.openElements(['thumbnailsPanel']), n.selectThumbnailPages([1]);
            }),
            ...
            (document.getElementById(''.concat(t.domElement, '-select')).onchange = function(t) {
              n.loadDocument(t.target.value);
            }),
            (document.getElementById(''.concat(t.domElement, '-file-picker')).onchange = function(t) {
              var r = t.target.files[0];
              r && n.loadDocument(r);
            }),
            (document.getElementById(''.concat(t.domElement, '-url-form')).onsubmit = function(r) {
              r.preventDefault(), n.loadDocument(document.getElementById(''.concat(t.domElement, '-url')).value);
            });
        }
      );
    };
