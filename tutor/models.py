...
class Exam(models.Model):
    ...
    center = models.ForeignKey(SignupCoachingCentre,related_name='centername',on_delete=models.CASCADE)
    course = models.ForeignKey(AddCourses,related_name="exams",on_delete=models.CASCADE)
...
class StudentMapping(models.Model):
    student = models.ForeignKey(SignupStudent, related_name='student_mapping',
                                on_delete=models.CASCADE)
    exam = models.ForeignKey(Exam,related_name='student_exam',on_delete=models.CASCADE)
    course = models.ForeignKey(AddCourses,related_name="student_course",on_delete=models.CASCADE)
