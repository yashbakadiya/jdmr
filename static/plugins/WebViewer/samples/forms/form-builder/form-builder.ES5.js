        ...
        (c.addFormFieldAnnot = function(t, r, c, f) {
          ...
          if (!n.x || null != h.first) {
            var p = null !== h.first ? h.first : e.getCurrentPage(),
              ...
              d = new o.FreeTextAnnotation();
            d.PageNumber = p;
            var g = 90 * e.getCompleteRotation(p);
            (d.Rotation = g),
              'CHECK' === t || 'RADIO' === t
                ? ((d.Width = 25 / a), (d.Height = 25 / a))
                : 270 === g || 90 === g
                ? ((d.Width = 50 / a), (d.Height = 250 / a))
                : ((d.Width = 250 / a), (d.Height = 50 / a)),
              (d.X = (y.x || v.width / 2) - d.Width / 2),
              (d.Y = (y.y || v.height / 2) - d.Height / 2),
              d.setPadding(new i.Math.Rect(0, 0, 0, 0)),
              d.setCustomData('name', r),
              d.setCustomData('type', t),
              d.setCustomData('value', c),
              d.setCustomData('flag', f),
              d.setContents(''.concat(r, '_').concat(t)),
              (d.FontSize = ''.concat(10 / a, 'px')),
              (d.FillColor = new o.Color(211, 211, 211, 0.5)),
              (d.TextColor = new o.Color(0, 165, 228)),
              (d.StrokeThickness = 1),
              (d.StrokeColor = new o.Color(0, 165, 228)),
              (d.TextAlign = 'center'),
              (d.Author = u.getCurrentUser()),
              u.deselectAllAnnotations(),
              u.addAnnotation(d, !0),
              u.redrawAnnotation(d),
              u.selectAnnotation(d),
              (n = {});
          }
        }),
