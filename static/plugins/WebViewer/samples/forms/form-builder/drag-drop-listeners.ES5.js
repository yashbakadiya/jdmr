!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        kt = function(t, n) {
          return It(this, pt.call(Ft(this), t, n));
        },
        Dt = function(t) {
          Ft(this);
      ...
      v(Ut, Ct),
        h(Ut, yt, Ct.values),
        v(Ut, { slice: kt, set: Dt, constructor: function() {}, toString: ht, toLocaleString: Lt }),
        At(Ut, 'buffer', 'b'),
        At(Ut, 'byteOffset', 'o'),
        At(Ut, 'byteLength', 'l'),
        At(Ut, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        (M && (x = s(M.call(new t()))) !== Object.prototype && x.next && (a(x, w, !0), e || 'function' == typeof x[l] || u(x, l, h)),
        _ &&
          F &&
          'values' !== F.name &&
          ((E = !0),
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            ...
            var I = b.groups;
            if (h) {
              var M = [E].concat(F, O, p);
              void 0 !== I && M.push(I);
              var A = String(n.apply(void 0, M));
            } else A = y(E, p, O, F, I, n);
