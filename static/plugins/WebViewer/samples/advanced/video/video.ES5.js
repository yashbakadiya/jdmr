!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Gt, Dt),
        p(Gt, dt, Dt.values),
        v(Gt, { slice: kt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Nt }),
        jt(Gt, 'buffer', 'b'),
        jt(Gt, 'byteOffset', 'o'),
        jt(Gt, 'byteLength', 'l'),
        jt(Gt, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      Q = function(t, n) {
        if (((t = S(t)), (n = _(n, !0)), t !== U || !i(B, n) || i(G, n))) {
          var r = I(t, n);
      ...
      nt = function(t) {
        for (var n, r = t === U, e = L(r ? G : S(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(U, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (a(
        (N = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === U && n.call(G, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), Y(this, t, E(1, r));
            };
          return u && q && Y(U, t, { configurable: !0, set: n }), X(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, w = 0, S = []; w < h.length; ) {
              ...
              var _,
                E = a(m, v ? h : h.slice(w));
              if (null === E || (_ = l(c(m.lastIndex + (v ? 0 : w)), h.length)) === x) w = u(h, w, y);
              else {
                    ...
                    'https://pdftron.s3.amazonaws.com/downloads/pl/video/video.mp4',
                                      ...
                                      case 0:
                                        return (
                                          ...
                                          (e = r
                                            ...
                                            .getAllAnnotations()),
                                          (t.next = 4),
                                          c.exportAnnotations({ links: !1, widgets: !1, annotList: e })
                                        );
                                      case 4:
                                        return (o = t.sent), (t.next = 7), n('video', o);
                                      case 7:
                      ...
                      r.on('documentLoaded', function() {
                        ...
                        new Promise(function(n) {
                          ...
                          .then(function(t) {
                            return r.getAnnotationManager().importAnnotations(t);
                          })
                          .then(function() {
                      ...
                      (a = !1),
                      r.on('pageComplete', function(t, n) {
                        if (!a) {
                          a = !0;
                          var i = function(t) {
                          ...
                          c.on('annotationChanged', function() {
                          ...
                          HyperList.create(S, {
                            ...
                            generate: function(t) {
                              ...
                              (r.id = 'frame'.concat(n)), (r.className = 'frame');
                              var e = document.createElement('div');
                              (e.id = 'innerFrame'.concat(n)),
                                (e.frameNumber = n),
                                (e.className = 'innerFrame'),
                                (e.style = 'min-width: '.concat(88, 'px; min-height: ', 50, 'px;')),
                                (r.onclick = function() {
                              ...
                              var o = i(
                                ...
                                u = E[n];
                              u && 'inprogress' !== u && e.appendChild(u), r.appendChild(e), r.appendChild(o);
                              var c = s.getFrameFromTime(x.currentTime);
                              return n === c && (r.setAttribute('data-state', 'selected'), (F = r)), r;
                            },
                          }),
                            l.appendChild(S),
                            x.addEventListener(
                                ...
                                regeneratorRuntime.mark(function t() {
                                  ...
                                  return regeneratorRuntime.wrap(function(t) {
                                    for (;;)
                                      switch ((t.prev = t.next)) {
                                        case 0:
                                          f.getVideo().updateAnnotationsToTime(x.currentTime),
                                            F && F.removeAttribute('data-state'),
                                            (n = s.getFrameFromTime(x.currentTime)),
                                            (F = o.document.getElementById('frame'.concat(n))) && F.setAttribute('data-state', 'selected');
                                        case 5:
                                        case 'end':
                                          return t.stop();
                                      }
                          ...
                          y.addEventListener('click', function(t) {
                            ...
                            y.addEventListener('mousemove', function(t) {
                              var n = y.getBoundingClientRect().width,
                                e = ((t.offsetX * r.getZoom()) / n) * y.max;
                              (M = e), b.setAttribute('data-state', 'visible'), (b.style = 'left: '.concat(t.offsetX, 'px;')), (b.innerHTML = ''.concat(s.getFormattedTime(e)));
                            }),
