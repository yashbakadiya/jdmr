      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = a(s(u(b.index), h.length), 0), P = [], M = 1; M < b.length; M++) P.push(void 0 === (x = b[M]) ? x : String(x));
            var F = b.groups;
            if (p) {
  ...
  function(t, n) {
    !(function(t) {
      var n = function(t, n, r) {
          return t * Math.cos(r) + n * Math.sin(r);
        },
        r = function(t, n, r) {
          return -1 * t * Math.sin(r) + n * Math.cos(r);
        },
        e = function(t, n) {
          for (var r = t.length, e = t[0].length, o = n[0].length, i = new Array(r), u = 0; u < r; ++u) {
            i[u] = new Array(o);
            for (var c = 0; c < o; ++c) {
              i[u][c] = 0;
              for (var f = 0; f < e; ++f) i[u][c] += t[u][f] * n[f][c];
            }
          }
          return i;
        },
      ...
      t.DiffAlignment = {
        ...
        rotatedX: n,
        rotatedY: r,
        retrievePageMatrix: function(t, n) {
          var r = t.docViewer,
            e = n + 1,
            o = r.getCompleteRotation(e),
            i = r.getPageWidth(e),
            u = r.getPageHeight(e),
            c = r.getPageZoom(e),
            f = window.getPageMatrix(c, o, { width: i, height: u }, 0, !0, t.iframeWindow.utils.getCanvasMultiplier());
          return { a: f.m_a, b: f.m_b, c: f.m_c, d: f.m_d, e: f.m_h, f: f.m_v };
        },
        createCanvasForLineAlignment: function(e, i, u, c, f, a, s, l) {
          var h = t.DiffUtil.createCanvas(e, i, l),
            p = h.getContext('2d'),
            v = Math.atan2(f.y - c.y, f.x - c.x),
            y = Math.atan2(s.y - a.y, s.x - a.x);
          p.setTransform(u.a, u.b, u.c, u.d, u.e, u.f), p.translate(c.x, c.y), (c.x > f.x || c.y > f.y || v > 0) && (v *= -1), p.rotate(v);
          var d = o(c.x, c.y, f.x, f.y),
            g = o(a.x, a.y, s.x, s.y) / d / l;
          p.scale(g, g), p.rotate(y);
          var m = -n(c.x, c.y, v + y) / g,
            b = -r(c.x, c.y, v + y) / g;
          return p.translate(m, b), p.translate(n(a.x, a.y, v + y) / g, r(a.x, a.y, v + y) / g), p.translate(-c.x * l, -c.y * l), h;
        },
        createBoundingBoxFromTransformationMatrix: function(t, n, r, o, i) {
          var u = [[n], [r], [1]],
            c = e(t, u),
            f = c[0][0],
            a = c[1][0],
            ...
            b = Math.min(f, l, v, g),
            x = Math.max(f, l, v, g);
          return [b, Math.min(a, h, y, m), x, Math.max(a, h, y, m)];
        },
      };
    })(window);
  },
