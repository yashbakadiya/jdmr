!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Lt = function() {
          return vt.apply(Tt ? ht.call(Mt(this)) : Mt(this), arguments);
        },
        Rt = {
          ...
          filter: function(t) {
            return Ft(this, H(Mt(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = a(s(u(b.index), h.length), 0), M = [], P = 1; P < b.length; P++) M.push(void 0 === (x = b[P]) ? x : String(x));
            var F = b.groups;
            if (p) {
              var A = [E].concat(M, O, h);
              void 0 !== F && A.push(F);
              var I = String(n.apply(void 0, A));
            } else I = y(E, h, O, M, F, n);
  ...
  function(t, n) {
    !(function(t) {
      var n = function(t, n) {
          return { x: n.x * t.a + n.y * t.c + 0, y: n.x * t.b + n.y * t.d + 0 };
        },
        r = function(t, n) {
          if (0 === t[n + 3]) return !0;
          for (var r = 0; r < 3; r++) if (255 !== t[n + r]) return !1;
          return !0;
        },
        e = function(t, n, r) {
          for (var e = 0; e < 4; e++) if (t[r + e] !== n[r + e]) return !1;
          return !0;
        },
        o = function(t, n) {
          var r = Math.floor(t / 4);
          return { x: r % n, y: Math.floor(r / n) };
        },
        i = function(t, n) {
          return 4 * (t.y * n + t.x);
        };
      t.DiffUtil = {
        decomposeMatrix: function(t) {
          var r = n(t, { x: 0, y: 1 }),
            e = n(t, { x: 1, y: 0 }),
            o = (180 / Math.PI) * Math.atan2(r.y, r.x) - 90,
            i = (180 / Math.PI) * Math.atan2(e.y, e.x);
          return { translateX: t.e, translateY: t.f, scaleX: Math.sqrt(t.a * t.a + t.b * t.b), scaleY: Math.sqrt(t.c * t.c + t.d * t.d), skewX: o, skewY: i, rotation: o };
        },
        getScaleForCanvasFromNudgeTool: function(t) {
          return t / 100 + 1;
        },
        getScaleStateForNudgeToolFromCanvas: function(t) {
          return 100 * (t - 1);
        },
        createCanvas: function(t, n, r) {
          var e = document.createElement('canvas'),
            o = e.getContext('2d');
          return (e.width = t), (e.height = n), (e.style.width = ''.concat(t / r, 'px')), (e.style.height = ''.concat(n / r, 'px')), (e.style.backgroundColor = ''), (o.fillStyle = 'white'), e;
        },
        diffPixels: function(t, n, u, c, f) {
          for (var a = t.getContext('2d').getImageData(0, 0, t.width, t.height), s = a.data, l = 0; l < s.length; l += 4) {
            var h = o(l, t.width),
              p = i(h, n.width),
              v = void 0,
              y = void 0;
            if (r(u, p) && r(s, p)) s[l + 3] = 0;
            else if (e(u, s, p)) (v = (s[p] + s[p + 1] + s[p + 2]) / 6), (s[l] = 128 + v), (s[l + 1] = 128 + v), (s[l + 2] = 128 + v);
            else if (h.y <= n.height && h.x <= n.width)
              if (r(u, p)) (y = Math.round(255 * f)), (v = (s[l] + s[l + 1] + s[l + 2]) / 3), (s[l] = v), (s[l + 1] = v), (s[l + 2] = 255), (s[l + 3] = y);
              else if (r(s, p)) (y = Math.round(255 * c)), (v = (u[p] + u[p + 1] + u[p + 2]) / 3), (s[l] = 255), (s[l + 1] = v), (s[l + 2] = v), (s[l + 3] = y);
              else {
                var d =
                    (v = ((u[p] + u[p + 1] + u[p + 2]) / 3 + (s[l] + s[l + 1] + s[l + 2]) / 3) / 2) * ((Math.abs(s[l] - u[p]) + Math.abs(s[l + 1] - u[p + 1]) + Math.abs(s[l + 2] - u[p + 2])) / 765),
                  g = v + d;
                (s[l] = g), (s[l + 1] = v - d), (s[l + 2] = g), (y = Math.max(Math.round(255 * c), Math.round(255 * f))), (s[l + 3] = y);
              }
          }
          var m = document.createElement('canvas');
          return (m.width = t.width), (m.height = t.height), m.getContext('2d').putImageData(a, 0, 0), m;
        },
        overlayPixels: function(t, n, e, u, c) {
          for (var f = t.getContext('2d').getImageData(0, 0, t.width, t.height), a = f.data, s = 0; s < a.length; s += 4) {
            var l = o(s, t.width),
              h = i(l, n.width),
              p = void 0;
            if (l.y <= n.height && l.x <= n.width)
              if (r(e, h) && r(a, h)) a[s + 3] = 0;
              else if (r(e, h)) (p = Math.round(255 * c)), (a[s + 3] = p);
              else if (r(a, h)) (p = Math.round(255 * u)), (a[s] = e[h]), (a[s + 1] = e[h + 1]), (a[s + 2] = e[h + 2]), (a[s + 3] = p);
              else {
                if (u > c) {
                  var v = c;
                  (a[s] = a[s] * v + e[s] * (1 - v)), (a[s + 1] = a[s + 1] * v + e[s + 1] * (1 - v)), (a[s + 2] = a[s + 2] * v + e[s + 2] * (1 - v)), (p = Math.round(255 * u));
                } else p = Math.round(255 * c);
                a[s + 3] = p;
              }
          }
          var y = document.createElement('canvas');
          return (y.width = t.width), (y.height = t.height), y.getContext('2d').putImageData(f, 0, 0), y;
        },
        computeNewCoordsFromZoomRotation: function(n, r, e, o) {
          var i = [e, o],
            u = 0;
          switch (r) {
            case 0:
          ...
          return (i[0] = t.DiffAlignment.rotatedX(e, o, u) * n), (i[1] = t.DiffAlignment.rotatedY(e, o, u) * n), i;
        },
      };
    })(window);
  },
