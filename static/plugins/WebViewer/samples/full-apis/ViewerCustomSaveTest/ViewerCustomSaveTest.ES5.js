  ...
  function(t, n) {
    ...
    (e = window.PDFNet),
                    ...
                    for (;;)
                      switch ((r.prev = r.next)) {
                        ...
                        case 22:
                          (r.t0 = r.sent),
                            (r.next =
                              r.t0 === e.Annot.Type.e_Widget || r.t0 === e.Annot.Type.e_Link || r.t0 === e.Annot.Type.e_Sound || r.t0 === e.Annot.Type.e_Movie || r.t0 === e.Annot.Type.e_FileAttachment
                                ? 25
                                : 26);
                          break;
                        case 25:
      ...
      window.addEventListener('documentLoaded', function() {
        readerControl.docViewer.getDocument().getFileData = i;
      });
  },
]);
