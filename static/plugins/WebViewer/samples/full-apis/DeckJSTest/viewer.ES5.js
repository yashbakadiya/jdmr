    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), q(t, n, r)) : N(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
      ...
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(G, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), q(this, t, E(1, r));
            };
        ...
        s = (function(t) {
          ...
          return {
            getBoolean: function(t, r) {
              var e = n[t];
              return a(e) ? (a(r) ? null : r) : 'true' === (e = e.toLowerCase()) || 'yes' === e || '1' === e || ('false' !== e && 'no' !== e && '0' !== e && !!t);
            },
            getString: function(t, r) {
              var e = n[t];
              return a(e) ? (a(r) ? null : r) : decodeURIComponent(e);
            },
          };
        })().getString('d');
      null !== s &&
        (window.loadDocument(s).then(function(r) {
        ...
        n.on('documentLoaded', function() {
          ...
          for (var n = 0; n < r; n++)
            (o = n),
              ...
              $('body').append(i),
              c.push(e);
          for (var o, i, u = 0; u < Math.min(r, 10); u++) l(u);
          $.deck('.slide');
        }),
              ...
              (function n() {
                ...
                (c[r] = i),
                  window.loadCanvasAsync(t, r + 1).then(function(t) {
                    c[r] = u;
                    var e = $(t);
                    e.addClass('canvasPage');
                    var o = $('#page' + r);
                    o.append(e), o.find('.loading').remove(), $.deck('enableScale');
                    var i = parseFloat(e.css('width')) - o.find('.deck-slide-scaler').width();
                    e.css('margin-left', -i / 2 + 'px'),
                      f.length > 1
                        ? setTimeout(function() {
                            f.shift(), n();
                          }, 0)
