!(function(t) {
        ...
        Lt = {
          ...
          subarray: function(t, n) {
            var r = Pt(this),
              e = r.length,
              o = b(t, e);
            return new (k(r, r[bt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, d((void 0 === n ? e : b(n, e)) - o));
          },
        },
        Rt = function(t, n) {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      tt = function(t) {
        for (var n, r = k(w(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == D || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === V, e = k(r ? B : w(t)), o = [], u = 0; e.length > u; ) !i(U, (n = e[u++])) || (r && !i(V, n)) || o.push(U[n]);
        return o;
      };
    z ||
      (f(
    ...
    (r = jQuery),
      ...
      (i = function(t, n, o) {
        var i = r[e]('getOptions'),
          u = r[e]('getSlides').length - 1,
          c = r[e]('getSlide', o - 1),
          f = r[e]('getSlide', o + 1),
          a = window.location.href.replace(/#.*/, ''),
          s = c ? c.attr('id') : void 0,
          l = f ? f.attr('id') : void 0;
        r(i.selectors.previousLink)
          .toggleClass(i.classes.navDisabled, !o)
          .attr('href', a + '#' + (s || '')),
          r(i.selectors.nextLink)
            .toggleClass(i.classes.navDisabled, o === u)
            .attr('href', a + '#' + (l || ''));
      }),
      r.extend(!0, r[e].defaults, { classes: { navDisabled: 'deck-nav-disabled' }, selectors: { nextLink: '.deck-next-link', previousLink: '.deck-prev-link' } }),
      o
        .bind('deck.init', function() {
          ...
          r(n.selectors.previousLink)
            ...
            .bind('click.decknavigation', function(t) {
              r[e]('prev'), t.preventDefault();
            }),
            r(n.selectors.nextLink)
              .unbind('click.decknavigation')
              .bind('click.decknavigation', function(t) {
                r[e]('next'), t.preventDefault();
              }),
