...
*/
    !(function(t, n, r, e) {
      var o,
        ...
        p = {
          init: function(r, e) {
            ...
            (s = t.extend(!0, {}, t[n].defaults, e)),
              (o = []),
              (i = 0),
              (u = t(s.selectors.container)),
              (v = s.touch.swipeTolerance),
              l.trigger(f),
              ...
              l
                ...
                .undelegate('input, textarea, select, button, meter, progress, [contentEditable]', 'keydown', y)
                .delegate('input, textarea, select, button, meter, progress, [contentEditable]', 'keydown', y),
              u
                .unbind('touchstart.deck')
                .bind('touchstart.deck', function(n) {
                  c || (c = t.extend({}, n.originalEvent.targetTouches[0]));
                })
                .unbind('touchmove.deck')
                .bind('touchmove.deck', function(r) {
                  t.each(r.originalEvent.changedTouches, function(r, e) {
                    if (c && e.identifier === c.identifier)
                      return (
                        e.screenX - c.screenX > v || e.screenY - c.screenY > v
                          ? (t[n]('prev'), (c = void 0))
                          : (e.screenX - c.screenX < -1 * v || e.screenY - c.screenY < -1 * v) && (t[n]('next'), (c = void 0)),
                        !1
                      );
                  }),
                    r.preventDefault();
                ...
                .bind('touchend.deck', function(n) {
                  t.each(n.originalEvent.changedTouches, function(t, n) {
                    c && n.identifier === c.identifier && (c = void 0);
                  });
                })
                .scrollLeft(0)
                .scrollTop(0),
              t.each(o, function(r, e) {
                e.unbind('webkitTransitionEnd.deck').bind('webkitTransitionEnd.deck', function(r) {
                  if (e.hasClass(t[n]('getOptions').classes.current)) {
                    var o = t(this)
                      .find('iframe')
                      .css('opacity', 0);
      ...
      (t[n] = function(t, n) {
        ...
        l.bind('deck.change', function(r, e, o) {
          var i = t[n]('getSlide', e).find('iframe'),
            u = t[n]('getSlide', o).find('iframe');
          i.each(function() {
            var n = t(this),
              r = n.attr('src');
