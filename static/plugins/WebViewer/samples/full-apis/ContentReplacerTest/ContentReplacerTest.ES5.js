            ...
            var t,
              e =
                ((t = regeneratorRuntime.mark(function t() {
                  var r, e, o, i, u, c, f, a, s, l, p, h, v, y, d;
                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 62:
                            return (p = t.sent).initSecurityHandler(), p.lock(), (t.next = 67), n.ContentReplacer.create();
                          case 67:
                            return (h = t.sent), (t.next = 70), p.getPage(1);
                          case 70:
                            return (v = t.sent), (t.next = 73), v.getMediaBox();
                          case 73:
                            return (y = t.sent), (t.next = 76), h.addText(y, 'The quick onyx goblin jumps over the lazy dwarf');
                          case 76:
                            return (t.next = 78), h.process(v);
                          case 78:
                            return (t.next = 80), p.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused);
                          case 80:
