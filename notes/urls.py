...
urlpatterns = [
    ...
    path('sample/Institute/view/<int:pk>',viewInstituteSamplePDF,name="viewinstitutesamplepdf"),
    path('sample/Tutor/view/<int:pk>',viewTutorSamplePDF,name="viewtutorsamplepdf"),
