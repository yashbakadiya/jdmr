...
admin.site.register(TutorMultipleAnswer)
...
admin.site.register(TutorStudentAnswer)
admin.site.register(TutorStudentExamResult)
admin.site.register(TutorStudentMapping)
